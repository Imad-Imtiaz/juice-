...
const appCss = "/assets/styles-C1T_B5g4.css";
...
const Route$f = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Home -Portal Juice" },
      {
        name: "description",
        content: "Portal Juice Home is a React-based landing page for a premium wellness brand."
      },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Home -Portal Juice" },
      {
      ...
      { name: "twitter:title", content: "Home -Portal Juice" },
      {
      ...
      {
        property: "og:image",
        content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fbca52ba-1044-4206-a2fa-2ec11b076eb4/id-preview-85dca332--edcc900d-b89b-4176-8c6f-b83c49e061b6.lovable.app-1778764438733.png"
      },
      {
        name: "twitter:image",
        content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/fbca52ba-1044-4206-a2fa-2ec11b076eb4/id-preview-85dca332--edcc900d-b89b-4176-8c6f-b83c49e061b6.lovable.app-1778764438733.png"
...
const $$splitComponentImporter$e = () => import("./contact-DsW3ciJM.js");
const Route$e = createFileRoute("/contact")({
  head: () => ({
    meta: [{
      title: "Contact — Portal Juice"
    }, {
      name: "description",
      content: "Get in touch with Portal Juice — Gateway to Health."
    }, {
      property: "og:title",
      content: "Contact — Portal Juice"
    }, {
      property: "og:description",
      content: "Reach out to Portal Juice in Dubai."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$e, "component")
});
const $$splitComponentImporter$d = () => import("./about-CFQE667h.js");
const Route$d = createFileRoute("/about")({
  head: () => ({
    meta: [{
      title: "About — Portal Juice"
    }, {
      name: "description",
      content: "Portal Juice is your Gateway to Health — cold-pressed juices crafted in Dubai with no added sugar, no water dilution, and no artificial additives."
    }, {
      property: "og:title",
      content: "About — Portal Juice"
    }, {
      property: "og:description",
      content: "Cold-pressed wellness juices crafted with care in Dubai."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./index-CsngxC_h.js");
const Route$c = createFileRoute("/")({
  head: () => ({
    meta: [{
      title: "Portal Juice — Gateway To Health"
    }, {
      name: "description",
      content: "Portal Juice — cold-pressed wellness blends crafted by purpose. No added sugar, no added water. Just ingredients that work."
    }, {
      property: "og:title",
      content: "Portal Juice — Gateway To Health"
    }, {
      property: "og:description",
      content: "Cold-pressed wellness blends, crafted by purpose."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./juices.index-DqWp9ea9.js");
const Route$b = createFileRoute("/juices/")({
  head: () => ({
    meta: [{
      title: "Juices — Portal Juice"
    }, {
      name: "description",
      content: "Eight cold-pressed juice blends crafted for specific wellness goals. No added sugar. No added water."
    }, {
      property: "og:title",
      content: "Juices — Portal Juice"
    }, {
      property: "og:description",
      content: "Premium cold-pressed juices for High Blood Pressure, Diabetes, Arthritis, Asthma, Cholesterol, Weight Loss, Eye Care and Energy."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const flavor$7 = {
  title: "Weight Loss <em>Support</em> Juice",
  image: {
    src: "/images/weight-loss.png",
    alt: "Weight Loss Support juice bottle"
  },
  pricing: {
    price: 20,
    original: 39
  ...
  ingredients: ["Grapefruit", "Celery", "White Cabbage", "Turmeric"],
  seo: {
    title: "Weight Loss Support Juice — Portal Juice",
    description: "A light metabolism-boosting cold-pressed blend of cucumber, mint, lemon, green apple, celery, and ginger to support your wellness goals."
  }
};
const $$splitComponentImporter$a = () => import("./juices.weight-loss-CIPeL0r2.js");
const Route$a = createFileRoute("/juices/weight-loss")({
  head: () => ({
    meta: [{
      title: flavor$7.seo.title
    }, {
      name: "description",
      content: flavor$7.seo.description
    }, {
      property: "og:title",
      content: flavor$7.seo.title
    }, {
      property: "og:description",
      content: flavor$7.seo.description
    }, {
      property: "og:image",
      content: flavor$7.image.src
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./juices.payment-3svDLJwO.js");
const Route$9 = createFileRoute("/juices/payment")({
  validateSearch: (search) => {
    return {
      fullName: search.fullName || void 0,
      emailAddress: search.emailAddress || void 0,
      phoneNumber: search.phoneNumber || void 0,
      fullAddress: search.fullAddress || void 0,
      partner: search.partner || void 0,
      juice: search.juice || void 0,
      subscription: search.subscription || void 0
    };
  },
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const flavor$6 = {
  title: "High Cholesterol <em>Support</em> Juice",
  image: {
    src: "/images/high-cholesterol.png",
    alt: "High Cholesterol Support juice bottle"
  },
  pricing: {
    price: 20,
    original: 39
  ...
  ingredients: ["Apple", "Carrot", "White Cabbage", "Turmeric"],
  seo: {
    title: "High Cholesterol Support Juice — Portal Juice",
    description: "A cleansing cold-pressed blend of apple, carrot, beetroot, lemon, ginger, and garlic to support healthy cholesterol levels and overall heart wellness naturally."
  }
};
const $$splitComponentImporter$8 = () => import("./juices.high-cholesterol-Dz-9DS66.js");
const Route$8 = createFileRoute("/juices/high-cholesterol")({
  head: () => ({
    meta: [{
      title: flavor$6.seo.title
    }, {
      name: "description",
      content: flavor$6.seo.description
    }, {
      property: "og:title",
      content: flavor$6.seo.title
    }, {
      property: "og:description",
      content: flavor$6.seo.description
    }, {
      property: "og:image",
      content: flavor$6.image.src
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const heroHighBP = "/assets/juice-hero-new-B1v8iBfs.png";
const flavor$5 = {
  title: "High Blood Pressure <em>Support</em> Juice",
  image: {
    src: heroHighBP,
    alt: "High Blood Pressure Support juice bottle"
  },
  pricing: {
    price: 20,
    original: 39
  ...
  benefits: [{
    ...
    icon: "Sparkles",
    label: "Refreshing Daily\nWellness Support"
  }],
  ingredients: ["Beetroot", "Celery", "Pomegranate", "Ginger"],
  seo: {
    title: "High Blood Pressure Support Juice — Portal Juice",
    description: "Cold-pressed beetroot, hibiscus & celery wellness juice formulated to support healthy blood pressure, naturally."
  }
};
const $$splitComponentImporter$7 = () => import("./juices.hbp-CXPY615W.js");
const Route$7 = createFileRoute("/juices/hbp")({
  head: () => ({
    meta: [{
      title: flavor$5.seo.title
    }, {
      name: "description",
      content: flavor$5.seo.description
    }, {
      property: "og:title",
      content: flavor$5.seo.title
    }, {
      property: "og:description",
      content: flavor$5.seo.description
    }, {
      property: "og:image",
      content: flavor$5.image.src
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const flavor$4 = {
  title: "Eye Care <em>Support</em> Juice",
  image: {
    src: "/images/eye-care.png",
    alt: "Eye Care Support juice bottle"
  },
  pricing: {
    price: 20,
    original: 39
  ...
  benefits: [{
    ...
    icon: "Leaf",
    label: "Naturally rich\nin nutrients"
  }],
  ingredients: ["Carrot", "Pomegranate", "Orange", "Ginger"],
  seo: {
    title: "Eye Care Support Juice — Portal Juice",
    description: "A beta-carotene rich cold-pressed blend of carrot, orange, spinach, apple, beetroot, and lemon to nourish vision and provide antioxidant protection naturally."
  }
};
const $$splitComponentImporter$6 = () => import("./juices.eye-care-B_C3DdYq.js");
const Route$6 = createFileRoute("/juices/eye-care")({
  head: () => ({
    meta: [{
      title: flavor$4.seo.title
    }, {
      name: "description",
      content: flavor$4.seo.description
    }, {
      property: "og:title",
      content: flavor$4.seo.title
    }, {
      property: "og:description",
      content: flavor$4.seo.description
    }, {
      property: "og:image",
      content: flavor$4.image.src
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const flavor$3 = {
  title: "Energy <em>Support</em> Juice",
  image: {
    src: "/images/energy.png",
    alt: "Energy Support juice bottle"
  },
  pricing: {
    price: 20,
    original: 39
  ...
  ingredients: ["Orange", "Beetroot", "Carrot", "Ginger"],
  seo: {
    title: "Energy Support Juice — Portal Juice",
    description: "A vibrant cold-pressed blend of beetroot, orange, carrot, apple, ginger, and lemon to power your day and boost natural energy levels."
  }
};
const $$splitComponentImporter$5 = () => import("./juices.energy-D9vOGsrP.js");
const Route$5 = createFileRoute("/juices/energy")({
  head: () => ({
    meta: [{
      title: flavor$3.seo.title
    }, {
      name: "description",
      content: flavor$3.seo.description
    }, {
      property: "og:title",
      content: flavor$3.seo.title
    }, {
      property: "og:description",
      content: flavor$3.seo.description
    }, {
      property: "og:image",
      content: flavor$3.image.src
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const flavor$2 = {
  title: "Diabetes <em>Support</em> Juice",
  image: {
    src: "/images/diabetes.png",
    alt: "Diabetes Support juice bottle"
  },
  pricing: {
    price: 20,
    original: 39
  ...
  ingredients: ["Bitter Gourd", "Jamun", "Celery", "Ginger"],
  seo: {
    title: "Diabetes Support Juice — Portal Juice",
    description: "A low-glycemic green blend of cold-pressed bitter gourd, cucumber, spinach, and celery to help balance sugar levels naturally."
  }
};
const $$splitComponentImporter$4 = () => import("./juices.diabetes-D0Z8V3gU.js");
const Route$4 = createFileRoute("/juices/diabetes")({
  head: () => ({
    meta: [{
      title: flavor$2.seo.title
    }, {
      name: "description",
      content: flavor$2.seo.description
    }, {
      property: "og:title",
      content: flavor$2.seo.title
    }, {
      property: "og:description",
      content: flavor$2.seo.description
    }, {
      property: "og:image",
      content: flavor$2.image.src
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./juices.delivery-partners-BQZhLI0t.js");
const Route$3 = createFileRoute("/juices/delivery-partners")({
  validateSearch: (search) => {
    return {
      fullName: search.fullName || void 0,
      emailAddress: search.emailAddress || void 0,
  ...
  head: () => ({
    meta: [{
      title: "Delivery Partners — Portal Juice"
    }, {
      name: "description",
      content: "Select your preferred delivery platform for Portal Juice."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./juices.customer-info-ABb9X7jN.js");
const Route$2 = createFileRoute("/juices/customer-info")({
  validateSearch: (search) => {
    return {
      fullName: search.fullName || void 0,
      emailAddress: search.emailAddress || void 0,
  ...
  head: () => ({
    meta: [{
      title: "Customer Information — Portal Juice"
    }, {
      name: "description",
      content: "Enter your details to complete your Portal Juice order."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const flavor$1 = {
  title: "Asthma <em>Support</em> Juice",
  image: {
    src: "/images/asthma.png",
    alt: "Asthma Support juice bottle"
  },
  pricing: {
    price: 20,
    original: 39
  ...
  benefits: [{
    icon: "Sun",
    label: "Supports easier breathing"
  }, {
    icon: "Droplet",
    label: "Cooling and refreshing"
  }, {
    icon: "Leaf",
  ...
  seo: {
    title: "Asthma Support Juice — Portal Juice",
    description: "A clarifying cold-pressed blend of carrot, spinach, ginger, and apple to support healthy lung function and easier breathing."
  }
};
const $$splitComponentImporter$1 = () => import("./juices.asthma-HluOiaNw.js");
const Route$1 = createFileRoute("/juices/asthma")({
  head: () => ({
    meta: [{
      title: flavor$1.seo.title
    }, {
      name: "description",
      content: flavor$1.seo.description
    }, {
      property: "og:title",
      content: flavor$1.seo.title
    }, {
      property: "og:description",
      content: flavor$1.seo.description
    }, {
      property: "og:image",
      content: flavor$1.image.src
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const flavor = {
  title: "Arthritis <em>Support</em> Juice",
  image: {
    src: "/images/arthritis.png",
    alt: "Arthritis Support juice bottle"
  },
  pricing: {
    price: 20,
    original: 39
  ...
  ingredients: ["Pineapple", "Pomegranate", "Celery", "Turmeric"],
  seo: {
    title: "Arthritis Support Juice — Portal Juice",
    description: "An anti-inflammatory blend of cold-pressed pineapple, turmeric, carrot, and ginger to soothe joints and improve mobility naturally."
  }
};
const $$splitComponentImporter = () => import("./juices.arthritis-CP-JTcLK.js");
const Route2 = createFileRoute("/juices/arthritis")({
  head: () => ({
    meta: [{
      title: flavor.seo.title
    }, {
      name: "description",
      content: flavor.seo.description
    }, {
      property: "og:title",
      content: flavor.seo.title
    }, {
      property: "og:description",
      content: flavor.seo.description
    }, {
      property: "og:image",
      content: flavor.image.src
    }]
  }),
...
const JuicesIndexRoute = Route$b.update({
  id: "/juices/",
  path: "/juices/",
  getParentRoute: () => Route$f
});
const JuicesWeightLossRoute = Route$a.update({
  id: "/juices/weight-loss",
  path: "/juices/weight-loss",
  getParentRoute: () => Route$f
});
const JuicesPaymentRoute = Route$9.update({
  id: "/juices/payment",
  path: "/juices/payment",
  getParentRoute: () => Route$f
});
const JuicesHighCholesterolRoute = Route$8.update({
  id: "/juices/high-cholesterol",
  path: "/juices/high-cholesterol",
  getParentRoute: () => Route$f
});
const JuicesHbpRoute = Route$7.update({
  id: "/juices/hbp",
  path: "/juices/hbp",
  getParentRoute: () => Route$f
});
const JuicesEyeCareRoute = Route$6.update({
  id: "/juices/eye-care",
  path: "/juices/eye-care",
  getParentRoute: () => Route$f
});
const JuicesEnergyRoute = Route$5.update({
  id: "/juices/energy",
  path: "/juices/energy",
  getParentRoute: () => Route$f
});
const JuicesDiabetesRoute = Route$4.update({
  id: "/juices/diabetes",
  path: "/juices/diabetes",
  getParentRoute: () => Route$f
});
const JuicesDeliveryPartnersRoute = Route$3.update({
  id: "/juices/delivery-partners",
  path: "/juices/delivery-partners",
  getParentRoute: () => Route$f
});
const JuicesCustomerInfoRoute = Route$2.update({
  id: "/juices/customer-info",
  path: "/juices/customer-info",
  getParentRoute: () => Route$f
});
const JuicesAsthmaRoute = Route$1.update({
  id: "/juices/asthma",
  path: "/juices/asthma",
  getParentRoute: () => Route$f
});
const JuicesArthritisRoute = Route2.update({
  id: "/juices/arthritis",
  path: "/juices/arthritis",
  getParentRoute: () => Route$f
});
const rootRouteChildren = {
  ...
  AboutRoute,
  ContactRoute,
  JuicesArthritisRoute,
  JuicesAsthmaRoute,
  JuicesCustomerInfoRoute,
  JuicesDeliveryPartnersRoute,
  JuicesDiabetesRoute,
  JuicesEnergyRoute,
  JuicesEyeCareRoute,
  JuicesHbpRoute,
  JuicesHighCholesterolRoute,
  JuicesPaymentRoute,
  JuicesWeightLossRoute,
  JuicesIndexRoute
};
